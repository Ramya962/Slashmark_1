...
# Check if there are tasks and valid priorities before training the model
if not tasks.empty and 'priority' in tasks.columns and tasks['priority'].isin(['Low', 'Medium', 'High']).all():
    ...
    print("No valid tasks with priorities found. Train the model with valid data.")
